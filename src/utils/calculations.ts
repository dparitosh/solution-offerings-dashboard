  ...
  offerings.forEach(off => {
    ...
    off.subOfferings.forEach(sub => {
      ...
      'Sub offering Name': sub.name,
        'Mapping Relationship': sub.mapping?.relationship || '',
        'Updated Offering': sub.mapping?.updatedOffering || '',
        'Source Offering': sub.mapping?.sourceOffering || '',
        'Source Sub-offering': sub.mapping?.sourceSubOffering || '',
        'Source Sheet': sub.mapping?.sourceSheet || '',
        'Source Row': sub.mapping?.sourceRow ?? '',
        'Owner': sub.owner,
        'Quarter': sub.quarter,
